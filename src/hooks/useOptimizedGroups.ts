...
export function useOptimizedGroups(accessToken: string | null) {
  ...
  return {
    ...
    handleAddExpense: addExpenseMutation.mutateAsync,
    handleSimplifyDebts: simplifyDebtsMutation.mutateAsync,
    handleSettleAndSync: settleAndSyncMutation.mutateAsync,
    handleAddMember: addMemberMutation.mutateAsync,
    handleDeleteGroup: deleteGroupMutation.mutateAsync,
  }
}